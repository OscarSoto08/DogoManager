    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link" href='?pid=<?= base64_encode("ui/Breed/viewBreeds.php") ?>'><i class="fa-solid fa-paw"></i> View Breeds</a></li>
                    ...
                    <ul class="dropdown-menu">
                        <li>
                          <a class="dropdown-item" 
                            href="?pid=<?= base64_encode('ui/Walker/createWalker.php') ?>">
                            <i class="fa-solid fa-user-plus me-1"></i> Add Walker
                          </a>
                        </li>

                        <li>
                        <a class="dropdown-item" href='?pid=<?= base64_encode("ui/Walker/searchWalkers.php") ?>'>
                        ...
                        <li>
                            <a class="dropdown-item" href='?pid=<?= base64_encode("ui/Walker/viewAllWalkers.php") ?>'>
